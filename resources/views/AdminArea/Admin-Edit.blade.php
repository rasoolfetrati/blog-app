                ...
                <div class="card card-default">
                    <div class="card-body">
                        ...
                        <form action="{{ route('UpdatePost') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input class="mb-3 form-control form-control-lg" value="{{ $post->Title }}" type="text"
                                name="Title" placeholder="عنوان مقاله...">

                            <textarea id="editor1" name="Text" name="editor1" rows="10" data-sample-short>{{ $post->Text }}</textarea>

                            <br>
                            <p>خلاصه خبر </p>
                            <textarea class="mb-3 form-control" cols="6" name="Description">{{ $post->Description }}</textarea>

                            <input class="mb-3 form-control-file form-control" type="file" id="imginp" name="Image">

                            <img id="blah" width="150px" height="150px" class="img-thumbnail"
                            ...
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" name="IsEmergency" {{ $post->IsEmergency == true ? 'checked' : '' }} id="IsEmergency">
